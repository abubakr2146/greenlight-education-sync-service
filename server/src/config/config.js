...
// Load Airtable config with optional module override
function loadAirtableConfigForModule(moduleName = null) {
  const baseConfig = loadAirtableConfig();
  if (!baseConfig || !moduleName) {
    return baseConfig;
  }
